...
Los principales desafíos identificados para el sector incluyen la ya mencionada
...
tendencias de consumo, digitalización y sostenibilidad.
...
presentado comportamientos que requieren un seguimiento cercano. En marzo
...
Para el sector de la restauración, esto implica la necesidad de monitorizar de cerca
...
●  Márgenes Brutos y Netos: El margen bruto (ingresos menos COGS) suele ser
...
●  Pastelería / Obrador Pequeño: El Margen Neto pasa del 2.8% en gestión
...
productividad del equipo, sino que también puede aumentar la motivación y el
...
●  Optimización de Pedidos: Realizar pedidos ajustados a la demanda prevista,
...
○  Sistemas de Gestión de Cocina (KDS - Kitchen Display Systems):
...
○  Sensibilidad al Precio: Puede ser variable. Algunos turistas buscan opciones
...
productos o el propio establecimiento [source: 300].
...
Es uno de los pilares fundamentales de la regulación en restauración, con el objetivo
...
○  Retenciones e Ingresos a Cuenta: Por rendimientos del trabajo (nóminas),
...
energías renovables (placas solares, si la infraestructura lo permite), buen
...
Existen diversas certificaciones y sellos que pueden ayudar a los restaurantes a
...
Comprender el potencial de la IA es crucial para ofrecer asesoramiento
...
○  Sugerencias de Maridaje y Precios Dinámicos: La IA puede sugerir maridajes
...
○  Optimización de Planes de Mantenimiento: La IA permite pasar a un
...
liberando al personal [source: 9.3.3. Atención al Cliente y Soporte con IA, 'La
...
publicidad digital ajustando pujas y segmentaciones en tiempo real [source:
...
●  9.5.3. Delivery y Dark Kitchens (Cocinas Fantasma): Campo fértil para la IA.
...
●  Nacionales (España y Latinoamérica): Cluvi (Colombia - IA para entender y
...
alquileres pueden ser prohibitivos y consumir una parte desproporcionada de
...
●  Diferenciación a través de la Autenticidad y el Producto Local (Km 0): La
...
restaurantes, con proveedores, con el sector alojativo, con productores locales y
...
5.  Sostenibilidad como Eje Estratégico y Comercial: La demanda de prácticas
...
oferta de productos Km 0 [source: 178].

6.  Evolución Constante del Consumidor: El consumidor canario y el turista son
cada vez más informados, exigentes y conscientes. Valoran la autenticidad, la
calidad, las experiencias personalizadas, las opciones saludables y la
transparencia [source: 120]. El auge del delivery y el take away también ha
reconfigurado los hábitos de consumo [source: 86].

7.  Importancia de la Profesionalización de la Gestión: Los escenarios financieros

analizados (Sección 4.4) demuestran que un mayor nivel de madurez en la
gestión (control de costes, planificación estratégica, uso de KPIs, como el VCOR®
2.0 [source: 398]) se traduce directamente en una mejora significativa de la
rentabilidad (ej. del -2.8% al 23.6% de margen neto en un bar de barrio [source:

337]), independientemente del tamaño o tipo de establecimiento.

8.  Impacto Transformador de la Inteligencia Artificial (IA): La IA representa una
oportunidad estratégica para la optimización de procesos (inventarios, personal,
mantenimiento predictivo), la personalización de la oferta y la experiencia del
cliente, y la mejora del marketing y las ventas. Su adopción puede generar
eficiencias y diferenciar a los negocios en un mercado competitivo [source: 9.
Aplicaciones de la IA en el Sector Gastronómico, este informe].

11.2. Recomendaciones Estratégicas

Basándose en estas conclusiones, se proponen las siguientes recomendaciones
estratégicas, adaptadas tanto para los negocios de restauración en Canarias como
para las consultorías gastronómicas:
...
Ingeniería de Menú: Analizar la rentabilidad de cada plato (ej. usando
software de escandallos) y ajustar precios o recetas si el margen es bajo.
Apuntar a un coste de alimentos por debajo del 30% [source: 259].

○  Compras Inteligentes: Negociar con proveedores locales y de cercanía (Km
0) para optimizar precios y frescura, y reducir la huella de carbono. Explorar
cooperativas de hostelería para volumen.

○  Reducción de Mermas: Implementar control estricto de porciones, técnicas

de cocina de "desperdicio cero" y colaboración con iniciativas de donación de
excedentes (ej. Too Good To Go).

○  Control Laboral: Programar al personal en función de la demanda real

(usando datos históricos y proyecciones), buscando optimizar la
productividad por empleado (ej. ventas por camarero) y evitar horas extras
innecesarias.

○  Gestión de Alquiler: Si el alquiler supera el 8-10% de las ventas, buscar

renegociar o explorar modelos de renta variable.

○  Eficiencia Energética: Invertir en equipamiento eficiente (iluminación LED,
electrodomésticos Clase A), y considerar energías renovables (ej. paneles
solares con IGIC cero).

2.  Fortalecer la Experiencia del Cliente y la Propuesta de Valor:

○  Servicio de Excelencia: Capacitar al personal en técnicas de upselling y
cross-selling (sugerir maridajes de vinos canarios, postres caseros) y en
atención personalizada.

○  Ambiente y Autenticidad: Cuidar la ambientación del local y resaltar la
identidad canaria (ej. decoración, música, storytelling de los platos y

productos locales).

○  Fidelización: Implementar programas de fidelización para residentes

(descuentos, ventajas) y turistas (promociones para huéspedes de hoteles
colaboradores).

○  Diversificación de Canales: Potenciar el delivery y take away

(promocionando pedidos directos para evitar comisiones altas). Organizar
eventos privados, catas de vino canario o showcookings para generar
ingresos adicionales en horas valle [source: 276].

3.  Acelerar la Transformación Digital de Forma Inteligente (con enfoque en IA):
○  Adoptar Herramientas de Gestión Clave: Implementar TPV avanzados,
software de reservas online (ej. Covermanager), sistemas de gestión de
inventario y personal, que recojan datos de calidad.

○  Potenciar el Marketing Digital y la Reputación Online: Mantener una
presencia digital sólida (Google Maps, TripAdvisor, redes sociales con
contenido atractivo y auténtico). Animar y gestionar activamente las reseñas
positivas. Considerar el uso de IA para generar contenido y segmentar
audiencias [source: 9.4.1].

○  Explorar Aplicaciones de IA: Iniciar con proyectos piloto en áreas de IA con

claro ROI, como:
■  Predicción de Demanda: Para optimizar compras y evitar desperdicios.
■  Chatbots para Reservas y FAQs: Liberar personal y ofrecer servicio

■

24/7.
Ingeniería de Menús Asistida por IA: Para analizar rentabilidad y
popularidad de platos.

■  Análisis de Sentimiento de Reseñas: Para detectar problemas y mejorar

el servicio proactivamente.

○  Aprovechar Ayudas: Estar al tanto de programas como el Kit Digital
(disponible hasta junio de 2025 [source: 4, search results]) y otras
subvenciones autonómicas para la digitalización.
4.  Integrar la Sostenibilidad de Manera Transversal:

○  Plan de Sostenibilidad: Desarrollar un plan que abarque la gestión de

recursos (agua, energía), la reducción de residuos (plásticos de un solo uso,
desperdicio alimentario) y la compra responsable.

○  Priorizar Producto Local (Km 0): Abastecerse de productores canarios, no
solo por sostenibilidad sino por diferenciación y apoyo a la economía local
[source: 115].

○  Comunicación Transparente: Informar a los clientes sobre las prácticas

sostenibles (ej. en la carta o en la web), ya que esto es un factor de
diferenciación y atrae a un segmento creciente de consumidores

concienciados [source: 198]. Buscar sellos de calidad como la "Estrella Verde
Michelin" o el sello Km0 [source: 194].

5.  Invertir en el Talento Humano:

○  Mejorar Condiciones Laborales: Ofrecer salarios competitivos (dentro de
las posibilidades del negocio y de los convenios), buen ambiente laboral,
oportunidades de formación y desarrollo (incluyendo idiomas). Considerar
jornadas continuas o dos días de descanso consecutivos para mejorar la
conciliación [source: 46].

○  Formación Continua: Capacitar al personal en habilidades técnicas y

blandas (atención al cliente, idiomas, nuevas tecnologías).

○  Retención: Implementar programas de reconocimiento, incentivos y

desarrollo profesional. Combinar empleados fijos con fijos-discontinuos para
flexibilidad y estabilidad [source: 293].
6.  Fomentar la Colaboración y el Asociacionismo:

○  Sinergias: Participar en asociaciones sectoriales (Hostelería de España,
ASHOTEL, FEHT) y eventos (GastroCanarias, ferias Km0) para compartir
conocimientos, defender intereses comunes y acceder a recursos [source:
311].

○  Alianzas Estratégicas: Explorar colaboraciones con hoteles, productores
locales, bodegas o empresas de turismo para crear ofertas conjuntas o
promociones cruzadas [source: 312].

11.2.2. Para Consultorías Gastronómicas con Expertise en IA:

1.  Desarrollar un Expertise Profundo en IA Aplicada:

○  Formación Continua: Invertir en la capacitación del equipo en Machine
Learning, PLN, Computer Vision y herramientas de Business Intelligence
específicas para la gastronomía.

○  Alianzas Estratégicas: Colaborar con empresas tecnológicas especializadas

en IA para desarrollar soluciones a medida o complementar la oferta.

2.  Diseñar Ofertas de Servicio Especializadas en IA:

○  Diagnóstico y Hoja de Ruta Digital: Ofrecer servicios para evaluar la

madurez digital de los restaurantes y diseñar planes de transformación digital
que integren soluciones de IA escalonadamente [source: 9.7.1. Asesoramiento
Estratégico en la Adopción de IA, 'La Revolución Inteligente en la Mesa'
document].

○  Optimización de Costes con IA (Modelo VCOR® 2.0): Utilizar metodologías
como VCOR® 2.0 para guiar a los clientes en la implementación de IA en la
gestión de inventarios, predicción de demanda y análisis de rentabilidad de
menús, cuantificando el ahorro y el ROI esperado [source: 398].

○  Estrategias de Cliente y Marketing basadas en IA: Asesorar en la

implementación de chatbots, sistemas de recomendación personalizados, y
campañas de marketing digital optimizadas por IA para mejorar la experiencia
y la fidelización.

○  Formación y Gestión del Cambio: Ofrecer programas de capacitación para
el personal del restaurante sobre el uso de herramientas de IA y cómo la
tecnología puede mejorar su productividad y su rol, gestionando la resistencia
al cambio [source: 9.7.5. Formación y Gestión del Cambio, 'La Revolución
Inteligente en la Mesa' document].
3.  Actuar como "Traductores" y Facilitadores:

○  Simplificación de la Tecnología: Ayudar a los restauradores a entender los
beneficios de la IA en términos de negocio y rentabilidad, desmitificando la
tecnología y seleccionando las soluciones adecuadas a su escala y
presupuesto [source: 9.6.1. Desafíos de Implementación, 'La Revolución
Inteligente en la Mesa' document].

○  Cumplimiento Ético y Legal: Asesorar sobre las implicaciones éticas de la IA
(privacidad de datos, sesgos algorítmicos) y garantizar el cumplimiento de las
normativas de protección de datos (RGPD) [source: 9.6.2. Consideraciones
Éticas y Sociales, 'La Revolución Inteligente en la Mesa' document].

4.  Identificar Oportunidades Emergentes: Ayudar a los clientes a explorar nuevos
modelos de negocio impulsados por la IA (ej. dark kitchens eficientes con IA,
catering inteligente) o nichos de mercado basados en las tendencias analizadas
con herramientas de IA.

La implementación de estas recomendaciones requerirá un esfuerzo concertado y
una visión a largo plazo por parte de los empresarios y gestores del sector de la
restauración en Canarias. Aquellos que logren adaptarse, innovar y gestionar sus
negocios de manera profesional, eficiente y sostenible estarán mejor posicionados no
solo para superar los desafíos actuales, sino también para capitalizar las numerosas
oportunidades que ofrece este dinámico sector en un destino turístico de primer nivel
mundial.

12. Glosario de Términos de IA

La inteligencia artificial (IA) es un campo en rápida evolución con una terminología
específica que puede resultar desconocida para quienes no están familiarizados con
él. Este glosario tiene como objetivo definir algunos de los términos clave de IA
mencionados a lo largo de este informe y que son particularmente relevantes para su
aplicación en el sector gastronómico. La comprensión de estos conceptos facilitará a
los profesionales y consultores del sector la navegación por el panorama tecnológico

y la toma de decisiones informadas sobre la adopción de soluciones de IA.

●

Inteligencia Artificial (IA): Se refiere a la simulación de procesos de inteligencia
humana por parte de máquinas, especialmente sistemas informáticos. Estos
procesos incluyen el aprendizaje (la adquisición de información y reglas para el
uso de la información), el razonamiento (usando las reglas para llegar a
conclusiones aproximadas o definitivas) y la autocorrección. En el contexto
gastronómico, la IA se manifiesta en sistemas que pueden predecir la demanda,
personalizar ofertas, automatizar tareas o analizar datos de clientes [source: 11.
Glosario de Términos de IA, 'La Revolución Inteligente en la Mesa' document].

●  Aprendizaje Automático (Machine Learning - ML): Es una rama de la

inteligencia artificial que se centra en la idea de que los sistemas pueden
aprender de los datos, identificar patrones y tomar decisiones con una mínima
intervención humana. En lugar de ser programados explícitamente para realizar
una tarea específica, los algoritmos de ML utilizan datos históricos para construir
un modelo que luego puede hacer predicciones o tomar decisiones sobre nuevos
datos. Por ejemplo, un sistema de ML puede aprender de los datos de ventas
pasadas para predecir la demanda futura de ciertos platos [source: 11. Glosario
de Términos de IA, 'La Revolución Inteligente en la Mesa' document].
●  Procesamiento del Lenguaje Natural (PLN o NLP - Natural Language

Processing): Es un campo de la IA que se ocupa de la interacción entre las
computadoras y el lenguaje humano. El PLN permite a las máquinas comprender,
interpretar y generar lenguaje humano, tanto escrito como hablado. En la
industria gastronómica, el PLN es la tecnología detrás de los chatbots que
gestionan reservas, los asistentes de voz que toman pedidos en drive-thrus o los
sistemas que analizan el sentimiento de las reseñas online de los clientes [source:
11. Glosario de Términos de IA, 'La Revolución Inteligente en la Mesa' document].
●  Visión por Computadora (Computer Vision): Es un campo interdisciplinario que
se ocupa de cómo las computadoras pueden obtener una comprensión de alto
nivel a partir de imágenes o videos digitales. Desde la perspectiva de la
ingeniería, busca automatizar tareas que el sistema visual humano puede hacer.
En restaurantes, las aplicaciones incluyen el control de calidad de los alimentos
mediante el análisis de imágenes, el seguimiento de la eficiencia en la línea de
ensamblaje de alimentos o incluso el análisis del comportamiento de los clientes
en el local (respetando la privacidad) [source: 11. Glosario de Términos de IA, 'La
Revolución Inteligente en la Mesa' document].

●  Big Data: Se refiere a conjuntos de datos extremadamente grandes y complejos
que los software de procesamiento de datos tradicionales no pueden gestionar.
Estos datos pueden ser estructurados (como bases de datos de ventas) o no

estructurados (como comentarios en redes sociales o imágenes). La IA, y en
particular el Machine Learning, son herramientas clave para analizar Big Data y
extraer insights valiosos, como patrones de consumo de clientes, tendencias de
mercado o eficiencias operativas en el sector gastronómico [source: 11. Glosario
de Términos de IA, 'La Revolución Inteligente en la Mesa' document].

●  Chatbot: Un programa informático diseñado para simular una conversación
humana (escrita o hablada) a través de texto o voz. Los chatbots en el sector
gastronómico se utilizan comúnmente para gestionar reservas, responder
preguntas frecuentes de los clientes, tomar pedidos simples o proporcionar
información sobre el menú y los servicios del restaurante, operando 24/7 [source:
11. Glosario de Términos de IA, 'La Revolución Inteligente en la Mesa' document].

●  Análisis Predictivo (Predictive Analytics): Es una rama del análisis avanzado
que se utiliza para hacer predicciones sobre eventos futuros desconocidos. El
análisis predictivo utiliza muchas técnicas de la minería de datos, estadísticas,
modelado, Machine Learning e inteligencia artificial para analizar datos actuales y
hacer predicciones sobre el futuro. En gastronomía, se usa para predecir la
demanda de ingredientes, la afluencia de clientes, o incluso el posible éxito de un
nuevo plato [source: 11. Glosario de Términos de IA, 'La Revolución Inteligente en
la Mesa' document].

●  Sistema de Recomendación (Recommender System): Es una subclase de
sistema de filtrado de información que busca predecir la "calificación" o
"preferencia" que un usuario daría a un artículo. En el contexto de un restaurante,
un sistema de recomendación puede sugerir platos o bebidas a un cliente
basándose en sus pedidos anteriores, las preferencias de clientes similares, la
popularidad de los artículos o el contexto actual (hora, clima) [source: 11. Glosario
de Términos de IA, 'La Revolución Inteligente en la Mesa' document].

●

●  Reconocimiento de Voz (Speech Recognition): Es una tecnología que permite
a un programa informático procesar la voz humana y convertirla en un formato
legible por máquina, típicamente texto. Es un componente clave de los asistentes
de voz y los sistemas de toma de pedidos por voz utilizados en restaurantes para
mejorar la eficiencia y la experiencia del cliente [source: 11. Glosario de Términos
de IA, 'La Revolución Inteligente en la Mesa' document].
Internet de las Cosas (IoT - Internet of Things): Se refiere a la red de objetos
físicos ("cosas") que llevan incorporados sensores, software y otras tecnologías
con el fin de conectar e intercambiar datos con otros dispositivos y sistemas a
través de Internet. En la cocina de un restaurante, los equipos conectados
(hornos, refrigeradores) pueden generar datos que, analizados por IA, permiten el
mantenimiento predictivo o la optimización del consumo energético [source: 11.
Glosario de Términos de IA, 'La Revolución Inteligente en la Mesa' document].

●  Automatización Robótica de Procesos (RPA - Robotic Process Automation):
Aunque no es IA pura, a menudo se combina con ella. RPA es una tecnología que
permite configurar software o "robots" para emular e integrar las acciones de una
interacción humana con sistemas digitales para ejecutar un proceso de negocio.
En gastronomía, podría usarse para automatizar tareas administrativas repetitivas
[source: 11. Glosario de Términos de IA, 'La Revolución Inteligente en la Mesa'
document].
Ingeniería de Menús (Menu Engineering): Es el estudio de la rentabilidad y
popularidad de los ítems del menú y cómo estos dos factores influyen en la
colocación de estos ítems en un menú. La IA puede potenciar la ingeniería de
menús analizando grandes cantidades de datos de ventas para clasificar los
platos y ayudar a tomar decisiones sobre precios, promociones y diseño del
menú [source: 11. Glosario de Términos de IA, 'La Revolución Inteligente en la
Mesa' document].

●

●  Optimización de Rutas (Route Optimization): Proceso de determinar la ruta

más eficiente desde un punto de partida a un destino, o a través de una serie de
destinos. En el sector del delivery de comida, la IA se utiliza para optimizar las
rutas de los repartidores, considerando factores como el tráfico, la distancia y los
tiempos de entrega prometidos [source: 11. Glosario de Términos de IA, 'La
Revolución Inteligente en la Mesa' document].

13. Referencias y Fuentes Consultadas

Este informe se ha elaborado a partir de la consulta y síntesis de diversas fuentes,
incluyendo documentos proporcionados, artículos especializados, informes de la
industria, sitios web de empresas tecnológicas y bases de datos estadísticas oficiales.
A continuación, se detallan las principales referencias utilizadas:

●  Documentos Proporcionados:

○  Resumen Ejecutivo.docx: (Fuente principal para el resumen ejecutivo y datos

○

○

económicos y turísticos específicos de Gran Canaria).
Informe_Actualizado_Consolidado_Niveles_Gestion.docx: (Utilizado para la
definición de niveles de gestión G0-G3).
Informe_Consolidado_Final_Escenarios_1_a_8.docx: (Fuente principal para los
escenarios financieros operativos detallados de diversos tipos de negocios de
restauración bajo diferentes niveles de gestión).

○  Manual_VCOR_2_0.docx: (Manual metodológico para la validación de costes
operativos en restauración, utilizado para el marco conceptual de gestión de
costes).

○  La Revolución Inteligente en la Mesa: Aplicaciones Prácticas de la IA para la

○

Consultoría Gastronómica y Negocios del Sector (Documento completo sobre
IA, utilizado para la Sección 9 y menciones de IA en otras secciones).
Información Filtrada de Búsquedas Web para Informe Complementario sobre
Restauración en Canarias (2024-2025) (Snippets de búsqueda web con datos
y tendencias adicionales para el contexto canario).

○  Recopilación de Información: Aplicaciones de IA en Gastronomía (Documento
de apoyo para la sección de IA, con herramientas y ejemplos adicionales).

●  Artículos y Publicaciones Web (citados en los documentos fuente o en

búsquedas directas):
○  grancanaria.com: (Referencia para datos de facturación turística de Gran

Canaria) [source: 2, 14].

○  restauracionnews.com: (Referencia para el ticket medio nacional) [source: 6].
○  foodretail.es: (Referencia para la contención del gasto por cliente y el

mercado de comida a domicilio) [source: 7, 97, 209, 218].

○  europapress.es: (Referencia para el precio del menú del día en Canarias y Las

Palmas) [source: 8, 9, 209].

○  noticias8islas.com: (Referencia para el gasto medio diario de un turista en

Canarias y la tasa turística) [source: 11, 13, 78, 79, 170, 172].

○  elconfidencial.com: (Referencias para el aumento de costes operativos,

margen bruto de beneficio y negocios con pérdidas) [source: 17, 19, 20, 32,
235, 255].
ingenieriademenu.com: (Referencia para la estructura de costes de personal y
materias primas) [source: 22, 23, 223, 227].

○

○  es.marketman.com: (Referencias para gastos de ocupación y margen neto)

○

[source: 20, 24, 29, 234].
laspalmasgc.es: (Referencia para la recaudación por tasas de terrazas en Las
Palmas) [source: 27].

○  canariasnoticias.es: (Referencias para afiliación a la Seguridad Social y

llegadas de turistas) [source: 35, 75].

○  elpais.com: (Referencia para la rotación de personal y el salario medio en

hostelería) [source: 38, 45].

○  turismodeislascanarias.com: (Referencia para la reducción de temporalidad

en contratos turísticos y la disposición de turistas a gastar más en
sostenibilidad) [source: 42, 112].

○  combohr.com: (Referencia para el convenio colectivo de Hostelería de Las

Palmas y estrategias de personal) [source: 43, 46, 49].

○  tiempodecanarias.com: (Referencia para las subidas salariales en Santa Cruz

de Tenerife) [source: 44].

○  eleconomista.es: (Referencia para el gasto en delivery y takeaway y el

incremento de visitas) [source: 71, 87, 88, 214].

○  muxgo.es: (Referencia al restaurante Muxgo como caso de éxito en

sostenibilidad) [source: 55].

○  digitalfarocanarias.com: (Referencia a la estrategia Ecoisla Gran Canaria

2030) [source: 177].

○  km0grancanaria.com: (Referencia a las ferias itinerantes KM.0) [source: 117].
○  yaiza.es: (Referencia a la eliminación de la tasa de terrazas en Yaiza) [source:

164].

○  cadenaser.com/canarias: (Referencia a los Premios Qué Bueno Canarias

2025) [source: 3, search results].

○  guiarepsol.com: (Referencia a los Soles Sostenibles Repsol) [source: 3, search

results].

○  rtvc.es: (Referencia a la demanda de camareros cualificados en Canarias)

○

[source: 3, search results].
last.app: (Referencia a la información sobre Kit Digital, apps de gestión, y
tendencias de mercado) [source: 4, search results].

○  potenzzia.com: (Referencia a aplicaciones de IA en restaurantes, costes y

beneficios) [source: 4.1. Sistemas de Reserva y Gestión de Mesas Inteligentes,
'La Revolución Inteligente en la Mesa' document].

○  qz.com: (Referencia al uso de IA en cadenas de comida rápida como

McDonald's y Wendy's) [source: 9. Casos de Éxito y Ejemplos Inspiradores
(Nacionales e Internacionales), 'La Revolución Inteligente en la Mesa'
document].

○  forbes.co: (Referencia a Cluvi como caso de éxito en IA) [source: 9. Casos de
Éxito y Ejemplos Inspiradores (Nacionales e Internacionales), 'La Revolución
Inteligente en la Mesa' document].

○  HotelTechReport, Revfine.com, TecnoHotelNews: (Referencias para IA en
hoteles) [source: 9. Casos de Éxito y Ejemplos Inspiradores (Nacionales e
Internacionales), 'La Revolución Inteligente en la Mesa' document].

○  Deliverect: (Referencia para optimización de delivery) [source: 9.5.3. Delivery y

Dark Kitchens (Cocinas Fantasma), 'La Revolución Inteligente en la Mesa'
document].

○  AI Chef Pro: (Referencia para IA en catering y eventos) [source: 9.5.4. Catering
y Eventos Gastronómicos, 'La Revolución Inteligente en la Mesa' document].
...
●  Anexo I: Tablas de Escenarios Financieros Operativos: Se incluirían las tablas

detalladas de los 8 escenarios de negocio (Bar/Cafetería de Barrio, Restaurante
10 Mesas, Restaurante 25 Mesas, Pastelería/Obrador Pequeño, Catering para
Eventos, Negocio de Take Away/Comida para Llevar, Delivery Propio o por
Plataformas, Cocina Fantasma/Dark Kitchen) con el desglose de ingresos, costes
(materia prima, personal – neto, bruto contrato, coste empresa –, alquiler,
servicios, otros) y el cálculo de beneficio neto y margen neto para cada nivel de
gestión (G0, G1, G2, G3) [sources: 335-385].

●  Anexo II: Metodología VCOR® 2.0 – Detalle de Fases: Se podría expandir el

detalle de cada una de las cuatro fases de la metodología VCOR® 2.0
(Verificación de Datos, Cotejo con Referencias Dinámicas, Optimización
Multidisciplinar, Retroalimentación y Reporte Inteligente), así como sus
innovaciones (Loop VCOR+, Benchmarks dinámicos, G0-G3+ integrado,
Validación cruzada, Certificación VCOR®) [source: 398-406].

●  Anexo III: Gráficos de Tendencias: Gráficos que visualicen la evolución del PIB,
el empleo turístico, la inflación (general y de alimentos), las llegadas y el gasto
turístico en Canarias para el periodo analizado.

●  Anexo IV: Perfiles de Consumidor: Infografía o tabla comparativa detallada

sobre los perfiles de consumo del residente canario y el turista
